...
public static class I18n
{
    ...
    private static readonly Dictionary<string, (string En, string Es, string Fr)> Table = new()
    {
        ...
        ["media_volume_name"] = ("Media volume for you and remote listeners", "Volumen del contenido para ti y los oyentes remotos", "Volume du média pour vous et les auditeurs distants"),
